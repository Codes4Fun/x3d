...
g++ -g -Wl,--unresolved-symbols=ignore-in-shared-libs -I/usr/include -IsixenseSDK_linux_OSX/include -LsixenseSDK_linux_OSX/lib/linux_x64/release -lX11 -lXi -lGL -lGLU -lm -lsixense_x64 -o phasetest Matrix.cpp Vector.cpp Hydra.cpp phasetest.cpp XWindow.cpp
